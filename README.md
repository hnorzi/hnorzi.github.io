...
<html lang="fa"; dir="rtl"> 
 ...
 <body style="background-color:lightblue"> 
  <div> 
   ...
   <h2>ویژگی ها</h2> 
   <ul type="square"> 
    <li>سلام:<span style="font-weight:bold">خداحافظ</span></li> 
    <li>سلام:<span style="font-weight:bold">خداحافظ</span></li> 
    <li>سلام:<span style="font-weight:bold">خداحافظ</span></li> 
   </ul> 
   <h2>:قیمت</h2> 
 ...
 <a href="https://github.com/hnorzi/hnorzi.github.io-next-page/blob/main/README.md#hnorzigithubio-next-page">next-page</a>
